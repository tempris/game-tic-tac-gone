...
UI::UI(sf::RenderWindow& window, sf::Font& font)
    : window(window),
    startButton(0, 0, 200, 50, font, "Start Game"),
    quitButton(0, 0, 200, 50, font, "Quit"),
    doNothingButton(0, 0, 200, 50, font, "Do Nothing"),
    resumeButton(0, 0, 200, 50, font, "Resume"),
    mainMenuButton(0, 0, 200, 50, font, "Main Menu") {
}
